...
set inv = y #$<
  ...
  uvspec vis=$source options=avall stokes=ii interval=2e6  axis=velocity,amp device=/xs nxy=1,1 log=vel.log   #
    #emacs vel.log &										     
   wc -l vel.log										    #
   head vel.log										    #
   tail vel.log										    #
 ...
 invert vis=$source map=$source.imap beam=$source.beam sup=0 options=double slop=0.5 cell=3.0 imsize=3000 line=vel,$noch,$fich,$inc,$inc  # standard     imsize=1000 
